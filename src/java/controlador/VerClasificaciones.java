/*
 * Controlador VerClasificaciones
 */
package controlador;
 ...
 * @author Di Qi
 */
public class VerClasificaciones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String vista = "/verClasificaciones.jsp";
        ...
        if (request.getParameter("ligaId") != null) {
            ...
            //Ordenar los equipos
            Collections.sort(equipos, new ComparadorClasificacion());
            
            request.setAttribute("equipos", equipos);
            request.setAttribute("liga", ljc.findLiga(ligaId));
        }
